...
from models.ThreshNet79 import threshnet79
from models.ThreshNet95 import threshnet95
...
def main():
    ...
    parser.add_argument('--testBatchSize', default=200, type=int, help='testing batch size')
...
class Solver(object):
    ...
    def load_model(self):
        ...
        self.model = threshnet79().to(self.device)
        # self.model = threshnet95().to(self.device)
